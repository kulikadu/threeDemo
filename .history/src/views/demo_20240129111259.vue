...
onMounted(() => {
  ...
  function onClick(event: any) {
    ...
    if (intersectsCube.length > 0) {
      ...
      cube.geometry.faces[faceIndex].color.set(selectedFaceColor); // 设置颜色
      cube.material.vertexColors = THREE.FaceColors; // 如果材质支持顶点颜色，启用它
      cube.material.needsUpdate = true; // 更新材质
    }
